...
__C.DATASET.VID = CN()
__C.DATASET.VID.ROOT = '/media/usst/_dde_data/smallerhu_others/training_dataset/vid/crop511'
__C.DATASET.VID.ANNO = '/media/usst/_dde_data/smallerhu_others/training_dataset/vid/train.json'
__C.DATASET.VID.FRAME_RANGE = 100
__C.DATASET.VID.NUM_USE = 100000  # repeat until reach NUM_USE

__C.DATASET.YOUTUBEBB = CN()
__C.DATASET.YOUTUBEBB.ROOT = '/media/usst/_dde_data/smallerhu_others/training_dataset/yt_bb/crop511'
__C.DATASET.YOUTUBEBB.ANNO = '/media/usst/_dde_data/smallerhu_others/training_dataset/yt_bb/train.json'
__C.DATASET.YOUTUBEBB.FRAME_RANGE = 3
__C.DATASET.YOUTUBEBB.NUM_USE = -1  # use all not repeat

__C.DATASET.COCO = CN()
__C.DATASET.COCO.ROOT = '/media/usst/_dde_data/smallerhu_others/training_dataset/coco/crop511'
__C.DATASET.COCO.ANNO = '/media/usst/_dde_data/smallerhu_others/training_dataset/coco/train2017.json'
__C.DATASET.COCO.FRAME_RANGE = 1
__C.DATASET.COCO.NUM_USE = -1

__C.DATASET.DET = CN()
__C.DATASET.DET.ROOT = '/media/usst/_dde_data/smallerhu_others/training_dataset/det/crop511'
__C.DATASET.DET.ANNO = '/media/usst/_dde_data/smallerhu_others/training_dataset/det/train.json'
